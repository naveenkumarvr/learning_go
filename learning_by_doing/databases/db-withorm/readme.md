...
- This is pointer to the Gorm Default config struct. This gives you contorl over how Gorm work globally. You can change some of the gorm behavior by changing the values from the struct
